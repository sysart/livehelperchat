   ...
   JSON : {
    ...
    showStartWindow : function(url_to_open,delayShow) {
          ...
          if (closeHandler !== null){
              closeHandler.onclick = function() { lhc_obj.hide(); lh_inst.chatCloseCallback('user'); return false; };
          };
    ...
    chatCloseCallback : function(type){
    ...
    handleMessage : function(e) {
    	...
    	if (action == 'lhc_sizing_chat') {
    		...
    		lh_inst.hide();
                lh_inst.chatCloseCallback('message')
    	}
    }
};
